...
export function TrustStrip() {
  return (
    <section className="flex justify-center border-y border-border bg-surface/50 backdrop-blur-sm">
      <div className="mx-auto max-w-7xl px-4 md:px-6 py-8 grid grid-cols-1 md:grid-cols-3 gap-16">
